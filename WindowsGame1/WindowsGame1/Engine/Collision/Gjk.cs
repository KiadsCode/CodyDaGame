...
namespace WindowsGame1.Engine.Collision
{
    internal class Gjk
    {
        private Polygon2D polygonA;
        private Polygon2D polygonB;
        ...
        public bool CheckCollision()
        {
            ...
            Vector2 direction = polygonA.Points[0] - polygonB.Points[0];
            simplex.Add(Support(polygonA, polygonB, direction));
